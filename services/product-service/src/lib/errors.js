...
// Error handler tập trung: mọi lỗi (kể cả throw trong async handler — Express 5 tự bắt)
// đều trả JSON, không bao giờ làm crash process vì input sai.
// ApiError là lỗi chủ động (kể cả 5xx) -> giữ nguyên message cho client;
