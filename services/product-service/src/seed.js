...
const PRODUCTS = [
  ['Sữa NAN Optipro 1 800g', 'Nestlé', '0-6m', 385000, 50, 'Thụy Sĩ',
    ...
    'Đạm whey, lactose, dầu thực vật, HMO 2\'-FL, DHA, ARA, vitamin A/D/E/K, canxi, sắt, kẽm.', '/images/nan.png'],
  ['Sữa NAN Optipro 2 800g', 'Nestlé', '6-12m', 375000, 45, 'Thụy Sĩ',
    ...
    'Đạm whey, lactose, dầu thực vật, HMO, B. lactis, DHA, vitamin nhóm B, canxi, kẽm.', '/images/nan.png'],
  ['Sữa Aptamil Profutura số 1 800g', 'Aptamil', '0-6m', 690000, 30, 'Đức',
    ...
    'Lactose, dầu thực vật, GOS/FOS, Bifidobacterium breve, DHA, AA, nucleotides, vitamin & khoáng chất.', '/images/aptamil.png'],
  ['Sữa Aptamil Essensis số 3 800g', 'Aptamil', '1-3y', 615000, 25, 'New Zealand',
    ...
    'Sữa bò A2 hữu cơ, lactose, dầu thực vật hữu cơ, DHA, GOS, vitamin D, canxi.', '/images/aptamil.png'],
  ['Sữa Similac Total Comfort 1 820g', 'Abbott', '0-6m', 495000, 40, 'Mỹ',
    ...
    'Đạm whey thủy phân một phần, maltodextrin, dầu thực vật, HMO 2\'-FL, DHA, lutein, vitamin E.', '/images/similac.png'],
  ['Sữa Similac Eye-Q 4 900g', 'Abbott', '3-6y', 465000, 35, 'Mỹ',
    ...
    'Sữa bột tách béo, đường lactose, DHA, lutein, vitamin E tự nhiên, canxi, vitamin D3.', '/images/similac.png'],
  ['Sữa Enfamil A+ NeuroPro số 1 830g', 'Mead Johnson', '0-6m', 545000, 38, 'Mỹ',
    ...
    'Lactose, đạm sữa, MFGM, DHA, ARA, PDX/GOS, choline, vitamin & khoáng chất thiết yếu.', '/images/enfamil.png'],
  ['Sữa Enfagrow A+ NeuroPro số 3 830g', 'Mead Johnson', '1-3y', 465000, 42, 'Mỹ',
    ...
    'Sữa bột, lactose, dầu thực vật, MFGM, DHA, PDX/GOS, sắt, kẽm, vitamin nhóm B.', '/images/enfamil.png'],
  ['Sữa Meiji Infant Formula 0-1 800g', 'Meiji', '0-6m', 510000, 28, 'Nhật Bản',
    ...
    'Lactose, dầu thực vật, đạm whey, FOS, DHA, taurine, nucleotides, 27 vitamin & khoáng chất.', '/images/meiji.png'],
  ['Sữa Meiji Growing Up 1-3 800g', 'Meiji', '1-3y', 455000, 33, 'Nhật Bản',
    ...
    'Sữa bột nguyên kem, lactose, FOS, DHA, canxi, sắt, kẽm, vitamin D, vitamin K2.', '/images/meiji.png'],
  ['Sữa Dielac Alpha Gold IQ 2 800g', 'Vinamilk', '6-12m', 215000, 60, 'Việt Nam',
    ...
    'Sữa bột, lactose, dầu thực vật, colostrum, DHA, taurine, cholin, FOS/inulin, vitamin & khoáng.', '/images/vinamilk.png'],
  ['Sữa Dielac Grow Plus 2+ 850g', 'Vinamilk', '3-6y', 285000, 55, 'Việt Nam',
    ...
    'Sữa bột, đường, dầu thực vật, đạm whey, lysine, kẽm, sắt, vitamin nhóm B, FOS.', '/images/vinamilk.png'],
  ['Sữa Friso Gold 2 800g', 'FrieslandCampina', '6-12m', 545000, 26, 'Hà Lan',
    ...
    'Sữa bột tách béo, lactose, dầu thực vật, GOS, DHA, AA, nucleotides, vitamin & khoáng chất.', '/images/friso.png'],
  ['Sữa Friso Gold 4 850g', 'FrieslandCampina', '3-6y', 425000, 48, 'Hà Lan',
    ...
    'Sữa bột tách béo, lactose, dầu thực vật, GOS, DHA, vitamin C/D, kẽm, selen.', '/images/friso.png'],
];
